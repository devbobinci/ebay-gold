            ...
            {listings?.map((listing) => (
              ...
              >
                ...
                <div className="pt-2 space-y-4">
                  ...
                  <div
                    className={`flex items-center space-x-1 justify-end text-xs border w-fit ml-auto p-2 rounded-lg text-white ${listing.type ?  ListingType.Direct "bg-blue-500" : "bg-red-500"}`}
                  >
                    <p>
